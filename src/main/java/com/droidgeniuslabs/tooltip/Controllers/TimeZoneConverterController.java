...
public class TimeZoneConverterController {
    private final List<String> timeZones = Arrays.asList("Africa/Abidjan", "Africa/Accra", "Africa/Addis_Ababa",
		    ...
		    "Africa/El_Aaiun","Africa/Freetown","Africa/Gaborone","Africa/Harare", "Africa/Johannesburg","Africa/Juba",
		    ...
		    "America/Daw son","America/Dawson_Creek","America/Denver","America/Detroit",
		    ...
		    "America/Porto_Velho","America/Puerto_Rico","America/Punta_Arenas","America/Rankin_Inlet","America/Recife",
		    ...
		    "Asia/Chita","Asia/Colombo","Asia/Damascus","Asia/Dhaka","Asia/Dili","Asia/Dubai","Asia/Dushanbe","Asia/Famagusta",
		    ...
		    "Asia/Kathmandu","Asia/Khandyga","Asia/Kolkata","Asia/Krasnoyarsk","Asia/Kuala_Lumpur","Asia/Kuching","Asia/Kuwait","Asia/Macau",
		    "Asia/Magadan","Asia/Makassar","Asia/Manila","Asia/Muscat","Asia/Nicosia","Asia/Novokuznetsk","Asia/Novosibirsk","Asia/Omsk",
		    "Asia/Oral","Asia/Phnom_Penh","Asia/Pontianak","Asia/Pyongyang","Asia/Qatar","Asia/Qostanay","Asia/Qyzylorda","Asia/Riyadh",
		    ...
		    "Atlantic/South_Georgia","Atlantic/St_Helena","Atlantic/Stanley","Australia/Adelaide","Australia/Brisbane","Australia/Broken_Hill",
		    "Australia/Darwin","Australia/Eucla","Australia/Hobart","Australia/Lindeman","Australia/Lord_Howe","Australia/Melbourne",
		    "Australia/Perth","Australia/Sydney","Indian/Antananarivo","Indian/Chagos","Indian/Christmas","Indian/Cocos","Indian/Comoro",
		    "Indian/Kerguelen","Indian/Mahe","Indian/Maldives","Indian/Mauritius","Indian/Mayotte","Indian/Reunion","Pacific/Apia",
		    "Pacific/Auckland","Pacific/Bougainville","Pacific/Chatham","Pacific/Chuuk","Pacific/Easter","Pacific/Efate","Pacific/Fakaofo",
		    "Pacific/Fiji","Pacific/Funafuti","Pacific/Galapagos","Pacific/Gambier","Pacific/Guadalcanal","Pacific/Guam","Pacific/Honolulu",
		    "Pacific/Kanton","Pacific/Kiritimati","Pacific/Kosrae","Pacific/Kwajalein","Pacific/Majuro","Pacific/Marquesas","Pacific/Midway",
		    ...
		    "Pacific/Wake","Pacific/Wallis","Europe/Amsterdam","Europe/Andorra","Europe/Astrakhan","Europe/Athens","Europe/Belgrade","Europe/Berlin",
		    "Europe/BratislavaEurope/Brussels","Europe/Bucharest","Europe/Budapest","Europe/Busingen","Europe/Chisinau","Europe/Copenhagen","Europe/Dublin",
		    ...
		    "Europe/Skopje", "Europe/Sofia","Europe/Stockholm","Europe/Tallinn","Europe/Tirane","Europe/Ulyanovsk","Europe/Vaduz",
		    "Europe/Vatican", "Europe/Vienna", "Europe/Vilnius","Europe/Volgograd","Europe/Warsaw","Europe/Zagreb","Europe/Zurich");
    @FXML private ComboBox<String> fromTimeZone;
    @FXML private ComboBox<String> toTimeZone;
    @FXML private TextField timeInput;
    @FXML private Label resultLabel;
    public void onConvert() {
	try {
	String fromZone = fromTimeZone.getValue();
	String toZone = toTimeZone.getValue();
	...
	ZonedDateTime fromZonedDateTime = localTime.atDate(LocalDate.now()).atZone(fromZoneId);
	ZonedDateTime toZonedDateTime = fromZonedDateTime.withZoneSameInstant(toZoneId);
	String result = toZonedDateTime.toLocalTime().format(formatter);
	resultLabel.setText("Converted Time: " + result);
    } catch (Exception e) {
	resultLabel.setText("Invalid input or Time Zone.");
    }

    }
    public void initialize(){
	fromTimeZone.getItems().addAll(timeZones);
	toTimeZone.getItems().addAll(timeZones);
	fromTimeZone.setValue("Europe/Athens");
	toTimeZone.setValue("Europe/Sofia");
    }
}
